...
class Card extends Component {
  ...
  render() {  
    const inputData = [
      ...
      {title: 'Plural Noun', state: this.state.pluralNoun1, name: 'pluralNoun'},
      ...
      {title: 'Celebrity', state: this.state.celebFive, name: 'celebFive'},
